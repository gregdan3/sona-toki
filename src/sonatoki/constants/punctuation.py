...
from sonatoki.constants.ucsur import UCSUR_SENTENCE_PUNCT

# single quotes are word boundaries if not intra-word, but double quotes are sentence
# boundaries
# TODO: realistically, double quotes are only sentence boundaries when they
# contain enough tokens, certainly no fewer than 2.
...
# combined bc the result could be simpler than either independently
